use crate::models::{
    judge_servers::JudgeServerInfo, ranks::ACMRank, statistics::SubmissionStatistics,
    users::AuthConfig,
};
use regex::Regex;
use std::io::Read;
...
lazy_static! {
    ...
    pub static ref RESULT_STATISTICS_CACHE: RwLock<HashMap<(String, i32), SubmissionStatistics>> =
